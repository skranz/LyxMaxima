...
draw.window = function() {
  ...
  # Main page
  group.button <<- ggroup(container = group.main)
  group.button2 <<- ggroup(container = group.main)
  ...
  button.sign <<- gbutton("sign?",container=group.button, handler  = function(h,...) {button.sign.fun()} )	
  ...
  button.revsubst <<- gbutton("unsubst",container=group.button2, handler  = function(h,...) {button.revsubst.fun()} )	
  button.read <<- gbutton("read",container=group.button2, handler  = function(h,...) {button.read.fun()} )	
